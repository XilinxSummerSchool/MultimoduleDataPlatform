...
set rc [catch {
  ...
  set_property webtalk.parent_dir J:/7/bd_design/bd_design.cache/wt [current_project]
  set_property parent.project_path J:/7/bd_design/bd_design.xpr [current_project]
  set_property ip_repo_paths {
  j:/6/hls_prj
  J:/7/hls_prj
} [current_project]
  update_ip_catalog
  set_property ip_output_repo J:/7/bd_design/bd_design.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet J:/7/bd_design/bd_design.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files J:/7/bd_design/bd_design.srcs/sources_1/bd/design_1/design_1.bd
